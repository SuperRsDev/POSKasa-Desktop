...
public class OrdersReportController {
    ...
    public void initialize() {
        lblTitle.setText("Izvjestaji o narudžbama");
    ...
    public void printNumericAction(ActionEvent actionEvent) {
        try {
            new PrintReport().showReport(dao.getConn(), "ordersReport7days.jrxml");
    ...
    public void printGraphicAction(ActionEvent actionEvent) {
        try {
            new PrintReport().showReport(dao.getConn(), "ordersChartReport7days.jrxml");
        } catch (JRException e1) {
            e1.printStackTrace();
        }
    }
